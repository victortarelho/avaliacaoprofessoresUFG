...
public class CargaDados {
    ...
    public static void insereTipoAtividadesAdministrativasEDeRepresentacao(TipoAtividadeDAO tipoAtividadeDAO, AtividadeDAO atividadeDAO) {
        ...
        insereAtividade("Chefe de Gabinete", "2", 10, direcaoEFuncaoGratificada, atividadeDAO);

        insereAtividade("Coordenador ou assessor vinculado à Reitoria", "3", 10, direcaoEFuncaoGratificada, atividadeDAO);

        insereAtividade("Diretor de Unidade Acadêmica, de Unidade Acadêmica Especial ou do CEPAE", "4", 10, direcaoEFuncaoGratificada, atividadeDAO);

        insereAtividade("Diretor de Campus do interior", "5", 12, direcaoEFuncaoGratificada, atividadeDAO);

        insereAtividade("Vice-diretor de Campus do interior", "6", 12, direcaoEFuncaoGratificada, atividadeDAO);

        insereAtividade("Diretor Geral do Hospital das Clínicas", "7", 10, direcaoEFuncaoGratificada, atividadeDAO);

        insereAtividade("Coordenador ou assessor vinculado às Pró-Reitorias ou à Direção dos Campus do Interior", "8", 8, direcaoEFuncaoGratificada, atividadeDAO);

        insereAtividade("Coordenador de Programa de Pós-Graduação stricto sensu", "9", 8, direcaoEFuncaoGratificada, atividadeDAO);

        insereAtividade("Coordenador de Curso de Ensino Básico ou de Graduação", "10", 8, direcaoEFuncaoGratificada, atividadeDAO);

        insereAtividade("Vice-diretor de Unidade Acadêmica ou Unidade Acadêmica Especial ou do CEPAE", "11", 8, direcaoEFuncaoGratificada, atividadeDAO);

        insereAtividade("Diretor do Hospital Veterinário", "12", 8, direcaoEFuncaoGratificada, atividadeDAO);

        insereAtividade("Diretor de Órgão da Administração (CERCOMP, CGA, CEGRAF, CIAR, DDRH, CS, SIASS, Museu, Rádio, Biblioteca etc.)", "13", 8, direcaoEFuncaoGratificada, atividadeDAO);
        ...
        insereAtividade("Coordenador de curso de especialização, residência médica ou residência multiprofissional em saúde (total máximo a ser considerado neste item são 10 pontos)", "2", 10, atividadesAdministrativas, atividadeDAO);

        insereAtividade("Membro representante de classe da carreira docente no CONSUNI", "3", 10, atividadesAdministrativas, atividadeDAO);

        insereAtividade("Membro do Conselho de Curadores ou do Plenário do CEPEC ou de Conselho de Fundações", "4", 10, atividadesAdministrativas, atividadeDAO);

        insereAtividade("Atividades acadêmicas e administrativas designadas por portaria do Reitor, Pró-Reitor ou Diretor de Unidade Acadêmica com carga horária >=150 horas", "5", 10, atividadesAdministrativas, atividadeDAO);
        ...
        insereAtividade("Presidente da Comissão de Avaliação Institucional ou da Comissão Própria de Avaliação", "2", 5, outrasAtividadesAdministrativas, atividadeDAO);

        insereAtividade("Membros da Coordenação Permanente do Centro de Seleção", "3", 5, outrasAtividadesAdministrativas, atividadeDAO);

        insereAtividade("Diretores do HC", "4", 5, outrasAtividadesAdministrativas, atividadeDAO);

        insereAtividade("Presidente do Comitê de Ética em Pesquisa da UFG e do HC/UFG", "5", 5, outrasAtividadesAdministrativas, atividadeDAO);

        insereAtividade("Membros da CPPD ou da Comissão de Avaliação Institucional ou da Comissão Própria de Avaliação ou da CAD", "6", 3, outrasAtividadesAdministrativas, atividadeDAO);

        insereAtividade("Coordenador de Pesquisa ou de Ensino ou de Extensão ou de Estágio das Unidades Acadêmicas", "7", 3, outrasAtividadesAdministrativas, atividadeDAO);

        insereAtividade("Chefe de Departamento", "8", 3, outrasAtividadesAdministrativas, atividadeDAO);

        insereAtividade("Chefe do Pronto Socorro ou da Maternidade ou do CEROF do Hospital das Clínicas da UFG", "9", 3, outrasAtividadesAdministrativas, atividadeDAO);

        insereAtividade("Coordenador das Atividades de Interação com a Sociedade", "10", 3, outrasAtividadesAdministrativas, atividadeDAO);

        insereAtividade("Coordenador das Atividades de Pesquisa e de Pós–Graduação lato sensu", "11", 3, outrasAtividadesAdministrativas, atividadeDAO);

        insereAtividade("Membros do Comitê de Ética da UFG e do HC/UFG", "12", 3, outrasAtividadesAdministrativas, atividadeDAO);

        insereAtividade("Membros do Comitê Interno e Externo do PIBIC", "13", 3, outrasAtividadesAdministrativas, atividadeDAO);
        ...
        insereAtividade("Presidente do Sindicato de Docentes da UFG", "2", 10, atividadesDeRepresentacaoForaDaUFG, atividadeDAO);

        insereAtividade("Diretor do Sindicato de Docentes da UFG", "3", 3, atividadesDeRepresentacaoForaDaUFG, atividadeDAO);

        insereAtividade("Representante sindical com carga horária igual ou superior a 150 horas", "4", 10, atividadesDeRepresentacaoForaDaUFG, atividadeDAO);

        insereAtividade("Representante em entidade científica, artística e cultural com carga horária igual ou superior a 150 horas", "5", 10, atividadesDeRepresentacaoForaDaUFG, atividadeDAO);

        insereAtividade("Representante em comissão de órgão governamental com carga horária igual ou superior a 150 horas", "6", 10, atividadesDeRepresentacaoForaDaUFG, atividadeDAO);
